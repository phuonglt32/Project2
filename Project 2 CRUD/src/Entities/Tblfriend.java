...
@NamedQueries({
    ...
    , @NamedQuery(name = "Tblfriend.findByStatus", query = "SELECT t FROM Tblfriend t WHERE t.tblfriendPK.status = :status")})
public class Tblfriend implements Serializable {
    ...
    public Tblfriend(String userName1, String userName2, String status) {
        this.tblfriendPK = new TblfriendPK(userName1, userName2, status);
    }
